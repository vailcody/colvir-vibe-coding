...
export default function Slide17MCPWhat({}: SlideProps) {
  return (
    <>
      <span className="slide-number reveal">17</span>
      <h2 className="reveal">MCP: Model Context Protocol</h2>
      <p className="subtitle reveal" style={{ marginBottom: '1rem' }}>Открытый протокол для подключения AI-агентов к инструментам</p>
      <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
        <img
          src={`${import.meta.env.BASE_URL}central-university-2/futurama-head.jpg`}
          alt=""
          className="reveal"
