...
export default function Slide21ContextKing({}: SlideProps) {
  return (
    <>
      ...
      <img src={`${BASE}lesson-2/img/context-arena.jpg`} alt="OpenAI MRCR: Context Arena benchmark" className="reveal" style={{ width: '100%', maxWidth: 1100, borderRadius: 8, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }} />
    </>
  )
}
